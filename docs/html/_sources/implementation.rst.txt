...
When the it is impossible to suply the power to the device, there is a Lite version, equiped with a 18650 battery and a small solar panel. In addition, the devices doesn't have LCD display and goes to deep sleep when not in use to save energy.
